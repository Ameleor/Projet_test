...
all_data_bryant = pd.read_csv('data/supp_data_from_thiel_et_al_2018/table_3.tsv', sep='\t')
data_bryant = pd.read_csv('data/supp_data_from_thiel_et_al_2018/table_3_2col.csv')
...
df_photo_species = all_data_bryant[["Organism_name", "Phototrophic group"]]
...
# Filter to see how many of the bacteria from bryant didn't find a match
#unmerged_data_bryant = full_data_bryant[~full_data_bryant['Assembly'].isin(merged_data_csv['Assembly'])]

#print(unmerged_data_bryant)
